...
public class WhisperingDeathPagScreen extends AbstractContainerScreen<WhisperingDeathPagMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, Component.translatable("gui.dragon_of_berk.whispering_death_pag.label_habitat_all_habitats"), 16, 79, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.dragon_of_berk.whispering_death_pag.label_class_fire"), 16, 88, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.dragon_of_berk.whispering_death_pag.label_fire_type_propane"), 16, 97, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.dragon_of_berk.whispering_death_pag.label_tamanhopequeno"), 16, 106, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.dragon_of_berk.whispering_death_pag.label_length15_meters"), 16, 115, -12829636);
	}
