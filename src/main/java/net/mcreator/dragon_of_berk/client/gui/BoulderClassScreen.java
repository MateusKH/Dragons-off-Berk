...
public class BoulderClassScreen extends AbstractContainerScreen<BoulderClassMenu> {
	...
	public void init() {
		super.init();
		button_terrible_terror = Button.builder(Component.translatable("gui.dragon_of_berk.boulder_class.button_terrible_terror"), e -> {
			if (true) {
		...
		button_monstrous_nightmare = Button.builder(Component.translatable("gui.dragon_of_berk.boulder_class.button_monstrous_nightmare"), e -> {
			if (true) {
