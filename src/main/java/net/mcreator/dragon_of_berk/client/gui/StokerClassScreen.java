...
public class StokerClassScreen extends AbstractContainerScreen<StokerClassMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("dragon_of_berk:textures/screens/stoker_class.png");
	...
	public void init() {
		...
		button_terrible_terror = new Button(this.leftPos + 21, this.topPos + 10, 103, 20, Component.translatable("gui.dragon_of_berk.stoker_class.button_terrible_terror"), e -> {
			if (true) {
		...
		button_monstrous_nightmare = new Button(this.leftPos + 10, this.topPos + 37, 124, 20, Component.translatable("gui.dragon_of_berk.stoker_class.button_monstrous_nightmare"), e -> {
			if (true) {
