...
public class DragonOfBerkModItems {
	...
	public static final RegistryObject<Item> PAPA_TUDO_SPAWN_EGG = REGISTRY.register("papa_tudo_spawn_egg", () -> new ForgeSpawnEggItem(DragonOfBerkModEntities.PAPA_TUDO, -10092493, -13210, new Item.Properties()));
